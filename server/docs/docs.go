...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/sysPublicDictionary/findSysDictionary": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/sysPublicDictionary/getSysDictionaryList": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SetUserGameConfig"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "设置用户游戏配置",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
