...
func (b *BaseApi) TokenNext(c *gin.Context, user system.SysUser) {
	...
	if jwtStr, ok := jwtService.GetCacheJWT(user.Username); !ok {
...
func (b *BaseApi) ChangePassword(c *gin.Context) {
	...
	u := &system.SysUser{BASE_MODEL: global.BASE_MODEL{ID: uid}, Password: req.Password}
...
func (b *BaseApi) GetUserInfo(c *gin.Context) {
	...
	response.OkWithDetailed(gin.H{"userInfo": ReqUser, "menus": menus}, "获取成功", c)
}
